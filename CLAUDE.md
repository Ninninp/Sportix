...
**Reprendre ici** : le **J6 (calendrier des blocs de spécialisation)**, en commençant par les maquettes (le plan demande 2 variantes pour cet écran ; le bandeau de bloc de l'accueil est déjà dessiné dans la planche « Accueil J6 · aperçu » du canvas J5). Le test du son du J4 reste à faire à l'occasion.
