...
**Écrans du J6 codés le 22/09/2026**, pas encore validés : onglet Calendrier (`CalendarPage` : grille du mois, colonne S1/S2/D, mois précédent / suivant, carte du bloc en cours ou du prochain), `BlockFormPage` (nouveau / modifier, panneau « Nouvel objectif », avertissement de chevauchement), `BlockDetailPage` (tuiles, semaines, « + Semaine de deload » : panneau pour choisir la place, puis « Décaler » / « Laisser le chevauchement » si le bloc mord sur le suivant ; suppression), ligne du bloc sur l'accueil (`WeekBar`). Parcours complet piloté dans Chrome (puppeteer-core hors dépôt), thèmes clair et sombre.
