...
**Reprendre ici** :
1. `/code-review` du J6 (validé par l'utilisateur, relecture pas encore faite).
2. Reste du J6 (parcours § 3.6) : les séances de deload ne déclenchent pas la double progression.
3. Reporter dans le canvas J6 ce qui a changé depuis sa publication (bouton de deload retiré, réglage « Par semaine », couleurs des blocs, carte du bas, formulaire sans onglets, champ date en toutes lettres, chiffres des réglages − / +).
4. Puis J7 (stats et progression).
