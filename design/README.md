...
| J6 — Calendrier des blocs | [Sportix — Maquettes J6](https://claude.ai/artifact/9KuXG1SEWTr4adp429qfNB) | **À valider** — deux variantes du calendrier à départager | [`maquettes-j6/`](maquettes-j6/) |
...
- **J6 (21/09/2026), à valider** : 8 écrans × 2 thèmes. **Deux variantes de l'écran principal à départager** — A « Frise » (les blocs les uns sous les autres, le bloc en cours en grand, barre de semaines S1…S5 ; on lit la périodisation) et B « Mois » (vrai calendrier, colonne S1/S2/… à gauche, un point par séance faite, case du jour cerclée ; on lit les dates et l'assiduité). Les planches supposent qu'on garde les deux, avec un sélecteur Frise / Mois en haut ; si une seule suffit, le sélecteur saute. Autres écrans : calendrier vide, nouveau bloc (nom, objectif, premier jour, durée, deload, programme), nouvel objectif (panneau), détail d'un bloc (semaines, séances par semaine, « + Semaine de deload »), avertissement de chevauchement, accueil avec la ligne du bloc. Parti pris à confirmer : **un bloc commence un lundi et dure un nombre entier de semaines**, pour que la semaine du bloc et celle du calendrier soient la même chose.
